...
function showbars(){
     //this fuctions adds bars to the display
...
showbars(); 
function play(){ 
    //this function colorises the bars according to time lapsed
...
function start_pause(){
    if(intervalID==undefined){ 
        //if interval ID is undefined, we shall set a new interval
        play_music();
...
function shift(e){ 
    //for switching to different time during song play
    time = e.target.id;
    document.getElementById('audio').currentTime = time; 
    //on click over the bars, the value of time lapsed is changed
}
